...
def user_give ():
    ...
    length = len(players_final)

    return render_template("result.html", height=height, weight=weight, age=age, num=length, players=players_final)
